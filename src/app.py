    ...
    while True:
        ...
        for i in range(len(slv1_array_)):
            if i==1:
                ...
                print("sensor:", slv1_array_[i]['data'] + " value=" + str(slv1_array_[i]['valor']),"time:", datetime.now())
        time.sleep(0.3)
